...
const ProductForm = ({ isOpen, onClose, product = null, onSuccess }) => {
  ...
  // uses the full `brands` list so compatible-tagged brands still appear
  // there too — a brand can legitimately be both a regular brand AND a
  // compatible system (e.g. Nespresso is a brand you can also filter
  // products by system compatibility for), so filtering it out of the
  // main checklist was hiding it from general brand assignment entirely.
