...
export default function ActivityLog() {
      ...
      <div className="flex items-center justify-center h-96">
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-2">
            This page is only visible to Directors, IT administrators, and
            Managers.
          </p>
        </div>
      </div>
  ...
  const scopeNote = isScopedManager
    ? currentUser?.scope === "COUNTRY"
      ? "Showing your country's staff activity only"
      : "Showing HQ staff activity only"
        ...
        {loading ? (
          ...
          <div className="text-center py-24 text-gray-500 dark:text-gray-400">
            ...
            <p className="text-sm mt-1">
              Logs are recorded as admins perform actions in the system.
            </p>
          </div>
        ) : (
                  ...
                  <React.Fragment key={log._id}>
                    <tr className="hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <div className="text-gray-500 dark:text-gray-400 text-xs">
                              {log.user?.subRole || log.user?.email || "—"}
                            </div>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-3 max-w-xs">
                        <p
                          className="text-gray-800 dark:text-gray-200 text-xs truncate"
                      ...
                      <td className="px-4 py-3">
                        <div className="text-xs">
                          ...
                          {log.resourceName && (
                            <span
                              className="text-gray-500 dark:text-gray-400 block truncate max-w-[120px]"
                      ...
                      <td className="px-4 py-3">
                        {(log.changes?.before ||
                          ...
                          >
                            <ChevronDown
                              className={`w-4 h-4 transition-transform duration-200 ${expanded === log._id ? "rotate-180" : ""}`}
                            />
                          </button>
                        )}
                      </td>
                      ...
                      <tr className="bg-indigo-50/40 dark:bg-indigo-900/10">
                        <td colSpan={7} className="px-6 py-4">
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                            {log.metadata?.ip && (
                              <div>
                                <p className="font-semibold text-gray-600 dark:text-gray-400 mb-1 uppercase tracking-wide text-xs">
                                  {t("activityExt.requestInfo")}
                                </p>
                                <p className="text-gray-700 dark:text-gray-300">
                                  IP: {log.metadata.ip}
                                </p>
                                <p
                                  className="text-gray-500 dark:text-gray-500 truncate mt-1"
                            ...
                            {log.changes?.before && (
                              <div>
                                <p className="font-semibold text-red-600 dark:text-red-400 mb-1 uppercase tracking-wide text-xs">
                                  {t("activity.before")}
                                </p>
                            ...
                            {log.changes?.after && (
                              <div>
                                <p className="font-semibold text-green-600 dark:text-green-400 mb-1 uppercase tracking-wide text-xs">
                                  {t("activity.after")}
                                </p>
          ...
          <div className="flex items-center justify-between px-4 py-3 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="flex items-center gap-1">
              ...
              {[...Array(Math.min(5, totalPages))].map((_, i) => {
                const p =
                  Math.max(1, Math.min(filters.page - 2, totalPages - 4)) + i;
